    ...
    while apt.main_loop() {
        ...
        if keys.contains(KeyPad::R) {
            ...
            (p1, p2) = match day {
                ...
                4 => {
                    Day4::run(&get_input(include_str!("../../inputs/day4.txt")))
                }
                5 => {
                    Day5::run(&get_input(include_str!("../../inputs/day5.txt")))
                }
                6 => {
                    Day6::run(&get_input(include_str!("../../inputs/day6.txt")))
                }
                7 => {
                    Day7::run(&get_input(include_str!("../../inputs/day7.txt")))
                }
                8 => {
                    Day8::run(&get_input(include_str!("../../inputs/day8.txt")))
                }
                9 => {
                    Day9::run(&get_input(include_str!("../../inputs/day9.txt")))
                }
                10 => {
                    Day10::run(&get_input(include_str!("../../inputs/day10.txt")))
                }
                11 => {
                    Day11::run(&get_input(include_str!("../../inputs/day11.txt")))
                }
                12 => {
                    Day12::run(&get_input(include_str!("../../inputs/day12.txt")))
                }
                _ => {
